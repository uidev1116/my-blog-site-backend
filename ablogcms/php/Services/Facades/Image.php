 ...
 * @method static void resizeImg(string $srcPath, string $destPath, ?int $width = null, ?int $height = null, ?int $size = null, ?int $angle = null) 画像をリサイズ
 ...
 * @method static array{path: string, type: string, name: string, size: string, filesize: int} createImages(string $filepath, string $filename, array{normal?: int, tiny?: int, large?: int, square?: int} $sizes, string $destDir, bool $isRandomFileName = true, ?int $angle = null, bool $forceLarge = false) 画サイズ違い（tiny, square, large, normal）の画像を生成
