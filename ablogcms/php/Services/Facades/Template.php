 ...
 * @method static array buildImage(\Acms\Services\View\Contracts\ViewInterface|\Template $Tpl, int $entryId, string $pimageId, array{imageX: int, imageY: int, imageTrim?: bool | 'on' | 'off', imageZoom?: bool | 'on' | 'off', imageCenter?: bool | 'on' | 'off'} $config, array{unit: array<string, \Acms\Services\Unit\Contracts\Model>, media: array<int, array<string, mixed>>, fieldMainImage?: array<int, array<string, mixed>>} $eagerLoadingData) 画像をビルド
