...
/**
 * @phpstan-type WysiwygAttributes array{html: string}
 * @extends \Acms\Services\Unit\Contracts\Model<WysiwygAttributes>
 */
class Wysiwyg extends Model
{
    /**
     * ユニットの独自データ
     * @var WysiwygAttributes
     */
    private $attributes = [
        'html' => '',
    ];
    ...
    public function extract(array $request): void
    {
        ...
        $this->setField1($request["wysiwyg_html_{$id}"] ?? '');
    }
